                    ...
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                        ...
                        <li class="nav-item has-treeview">
                            ...
                            <ul class="nav nav-treeview">
                                ...
                                <li class="nav-item">
                                    <a href="../agency/agency.php" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Data Agency</p>
                                    </a>
                                </li>
        ...
        <div class="content-wrapper">
            ...
            <section class="content">
                ...
                <div class="container-fluid">
                    ...
                    <a href="tambah_kategori.php" class="btn btn-success btn-sm mb-3">+ Tambah Data Kategori</a>
                    <table class="table table-hover" id="myTable">
                        <thead>
                            <tr class="text-center align-middle">
                                ...
                                <th class="text-center" scope="col">ID Agency</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center align-middle"><?php echo $kategori_data["id_kategori"] ?></td>
                                <td class="text-center align-middle"><?php echo $kategori_data["jenis_kategori"] ?></td>
                                <td class="text-center align-middle"><?php echo $kategori_data["id_agency"] ?></td>
                                <td width="200px" class="text-center align-middle">
                                    <a href="edit_kategori.php?id_kategori=<?php echo $kategori_data['id_kategori']; ?>"
                                        class="btn btn-warning">Edit</a>
                                    <a href="delete_kategori.php?id_kategori=<?php echo $kategori_data['id_kategori']; ?>"
