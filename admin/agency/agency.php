        ...
        <div class="content-wrapper">
            ...
            <section class="content">
                ...
                <div class="container-fluid">
                    <h1 class="text-center">Data Agency</h1>
                    <a href="tambah_agency.php" class="btn btn-success btn-sm mb-3">+ Tambah Data Agency</a>
                    <table class="table table-hover" id="myTable">
                        <thead>
                            <tr class="text-center align-middle">
                                <th class="text-center" scope="col">No. </th>
                                <th class="text-center" scope="col">ID Agency</th>
                                <th class="text-center" scope="col">Nama Agency</th>
                        ...
                        <tbody>
                            ...
                            if (mysqli_num_rows($agency) > 0) {
                                while ($agency_data = mysqli_fetch_array($agency)) {
                            ?>
                            <tr>
                                <th class="text-center align-middle"><?php echo $no ?></th>
                                <td class="text-center align-middle"><?php echo $agency_data["id_agency"] ?></td>
                                <td class="text-center align-middle"><?php echo $agency_data["nama_agency"] ?></td>
                                <td width="200px" class="text-center align-middle">
                                    <a href="edit_agency.php?id_agency=<?php echo $agency_data['id_agency']; ?>"
                                        class="btn btn-warning">Edit</a>
                                    <a href="delete_agency.php?id_agency=<?php echo $agency_data['id_agency']; ?>"
