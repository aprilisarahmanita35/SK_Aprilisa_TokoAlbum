...
<head>
    <title>Toko Album Kpop | About Us</title>
    <meta charset="utf-8">
        ...
        <div class="container">
            <div class="row align-items-center py-5">
                <div class="col-md-6 text-white">
                    <h1>About Us</h1>
                    <p>
                        Selamat datang di Toko Album KPOP!
                        <br>
                        Kami adalah pusat informasi terkini mengenai promosi album K-pop favorit Anda.
                        Dibentuk dengan cinta dan dedikasi kepada industri musik Korea,
                        Toko Album Kpop hadir untuk menyajikan wawasan mendalam tentang
                        berbagai promosi album K-pop yang sedang berlangsung.
                    </p>
                </div>
                <div class="col-md-4">
                    <img src="assets/img/kwangya1.jpg" width="500px;">
                </div>
            </div>
        </div>
    </section>
